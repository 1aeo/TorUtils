...
${YELLOW}FILES USED:${NC}
    ...
    /home/krim/tor-instances/ - Source keys directory  
...
migrate_instances() {
    ...
    process_relay() {
        ...
        local source_keys_dir="/home/krim/tor-instances/$old_name"
...
migrate_torrc() {
    ...
    process_torrc() {
        ...
        local source_torrc="/home/krim/instances/$old_name/torrc"
...
generate_master_list() {
    ...
    while read -r old_relay new_relay; do
        ...
        elif [ -f "/home/krim/tor-instances/$old_relay/fingerprint" ]; then
            fingerprint=$(cat "/home/krim/tor-instances/$old_relay/fingerprint" 2>/dev/null | awk '{print $2}' | tr -d '\n' || echo "N/A")
        fi
